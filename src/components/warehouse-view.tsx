...
const SHELF_LAYOUT_CONFIG = {
	...
	columns: 5,
	levels: 5,
	rackPaddingRatio: 0.1,
	yPaddingRatio: 0.06,
	depthForwardRatio: 0.4,
	yOffsetRatio: -0.25,
};
...
function WarehouseScene({
	...
	React.useLayoutEffect(() => {
		...
		if (edgeMesh) edgeMesh.computeBoundingSphere();
...
export function WarehouseView() {
	...
	const handleItemsReady = React.useCallback(
		(nextItems: WarehouseItem[]) => setItems(nextItems),
		[],
	);
