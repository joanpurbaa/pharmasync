...
// Perbaikan 1: Tambahkan isOpen ke dalam interface props
...
// Perbaikan 2: Ambil (destructure) isOpen dari parameter
export default function AddItemModal({
    ...
    const handleFormSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setErrorMessage(null); // Membersihkan error lama jika sukses
            setIsSubmitting(false);
        }
    };

    // Sekarang baris ini tidak akan error lagi karena isOpen sudah didefinisikan di atas
                ...
                <div className="p-4 sm:p-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                    <div>
                        ...
                        <p className="text-xs text-slate-400 font-medium mt-0.5">
                            Daftarkan SKU baru ke master data. Stok fisik diinput lewat &quot;Terima
                            Barang Masuk&quot; setelah ini.
                        </p>
                    </div>
                    <button
                        onClick={onClose}
