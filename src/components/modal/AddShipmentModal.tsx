            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200">
                ...
                <form onSubmit={handleSubmit} className="p-5 space-y-4">
                    ...
                    <div className="space-y-1.5">
                        <label htmlFor="itemId" className="text-xs font-medium text-slate-500">Item</label>
                        <select
                            id="itemId"
                            value={itemId}
                    ...
                    <div className="space-y-1.5">
                        <label htmlFor="quantity" className="text-xs font-medium text-slate-500">Jumlah</label>
                        <input
                            id="quantity"
                            type="number"
                            min="1"
                    ...
                    <div className="space-y-1.5">
                        <label htmlFor="destinationId" className="text-xs font-medium text-slate-500">Mitra Tujuan</label>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1.5">
                            <label htmlFor="scheduledDate" className="text-xs font-medium text-slate-500">Tanggal</label>
                            <input
                                id="scheduledDate"
                                type="date"
                                value={scheduledDate}
                        ...
                        <div className="space-y-1.5">
                            <label htmlFor="scheduledTime" className="text-xs font-medium text-slate-500">Jam</label>
                            <input
                                id="scheduledTime"
                                type="time"
                                value={scheduledTime}
                    ...
                    <div className="space-y-1.5">
                        <label htmlFor="driverId" className="text-xs font-medium text-slate-500">Driver (opsional)</label>
                        <select
                            id="driverId"
                            value={driverId}
                    ...
                    <div className="space-y-1.5">
                        <label htmlFor="vehicleId" className="text-xs font-medium text-slate-500">Kendaraan (opsional)</label>
                        <select
                            id="vehicleId"
                            value={vehicleId}
                    ...
                    <div className="flex justify-end gap-2 pt-4">
                        ...
                        <button
                            ...
                            className="px-4 py-2 text-sm font-semibold text-white bg-primary cursor-pointer rounded-lg transition-colors shadow-sm disabled:opacity-50 flex items-center justify-center min-w-[140px]">
                            {isSubmitting
                                ? "Menyimpan..."
                                : editData
                                    ? "Simpan Perubahan"
