            ...
            <div className="relative h-14 rounded-xl bg-slate-50 border border-slate-100 overflow-hidden">
                ...
                {items.map((_, i) => (
                    <motion.div
                        ...
                        initial={{ left: "2%", scale: 0, opacity: 0 }}
                        animate={
                            isOld
                                ? {
                                      left: [
                        ...
                        transition={
                            isOld
                                ? {
                                      duration: 4.5,
                                      times: [
                                          0, 0.10, 0.20, 0.35, 0.42,
                                          0.55, 0.62, 0.72, 0.76, 0.90, 1,
                                      ],
                                      repeat: Infinity,
                                      delay: i * 0.9,
                                      ease: "easeInOut",
                ...
                <div className="grid sm:grid-cols-2 gap-8 sm:gap-10">
                    <div>
                        ...
                        <p className="text-xs text-slate-400 mb-3">
                            Tiap kotak mewakili 1 rak obat — warna menunjukkan
                            status stoknya.
                        </p>
                            ...
                            {flowSteps[mode].map((step, i) => (
                                <div
                                    ...
                                    {i < flowSteps[mode].length - 1 && (
                                        <span className="hidden sm:block text-slate-300 text-xs">
                                            →
                                        </span>
                                    )}
                                </div>
