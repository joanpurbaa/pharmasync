                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="inline-flex items-center gap-1">
                        ...
                        <button
                          ...
                          className="text-xs font-semibold text-slate-600 hover:text-slate-900 transition-colors ml-1"
                        >
                          Detail
                        </button>
                      </div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tindakan ini tidak dapat dibatalkan. Data item beserta seluruh batch stok yang terkait akan dihapus permanen.
            </AlertDialogDescription>
            {deleteError && (
